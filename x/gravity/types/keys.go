...
const (
	OrchestratorAddressKey      = "OrchestratorAddress-value-"
	OrchestratorAddressCountKey = "OrchestratorAddress-count-"
)

func KeyPrefix(s string) []byte {
	return []byte(s)
}

const (
	CosmosToEthKey      = "CosmosToEth-value-"
	CosmosToEthCountKey = "CosmosToEth-count-"
)
