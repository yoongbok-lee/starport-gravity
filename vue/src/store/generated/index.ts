...
import AltheaNetCosmosGravityBridgeGravityV1 from './althea-net/cosmos-gravity-bridge/gravity.v1'
...
export default { 
  AltheaNetCosmosGravityBridgeGravityV1: load(AltheaNetCosmosGravityBridgeGravityV1, 'gravity.v1'),
